...
ui <- dashboardPage(
  dashboardHeader(title = tagList(
    tags$div(
      tags$span(style = "font-size: 14px; font-weight: 600; color: #E6F0FA;", "Ecotracker - Gestor de Residuos v1.0.0"),
      tags$br(),
      tags$span(style = "font-size: 8px; font-weight: 400; color: #E6F0FA;", "By JDR Analytics")
    )   
  ), titleWidth = 300),
  dashboardSidebar(
    width = 300,
